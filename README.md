...
across major versions. For further details read the Greengage Database Upgrade [documentation](https://gpdb.docs.pivotal.io/upgrade/) and [blog post](https://greengage.org/greenplum-database-upgrade/). 
