-- Avoid using syntax specific to Greengage 6 or Greengage 7 in here, 
-- because this script is executed in both versions.
...
-- check defaults
SELECT c.relname, att.attname, ad.adnum, pg_get_expr(ad.adbin, ad.adrelid)
FROM pg_class c
JOIN pg_attrdef ad ON ad.adrelid = c.oid
