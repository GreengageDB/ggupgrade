...
!\retcode (/bin/bash -c "source ${GPHOME_SOURCE}/greengage_path.sh && ${GPHOME_SOURCE}/bin/gpconfig -c debug_burn_xids -v on --skipvalidation");
!\retcode (/bin/bash -c "source ${GPHOME_SOURCE}/greengage_path.sh && ${GPHOME_SOURCE}/bin/gpstop -au");
...
!\retcode (/bin/bash -c "source ${GPHOME_SOURCE}/greengage_path.sh && ${GPHOME_SOURCE}/bin/gpconfig -r debug_burn_xids --skipvalidation");
!\retcode (/bin/bash -c "source ${GPHOME_SOURCE}/greengage_path.sh && ${GPHOME_SOURCE}/bin/gpstop -au");
